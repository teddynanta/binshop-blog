...
return [
    ...
    'blog_prefix' => "home", // used in routes.php. If you want to your http://yoursite.com/latest-news (or anything else), then enter that here. Default: blog
    'admin_prefix' => "dashboard", // similar to above, but used for the admin panel for the blog. Default: blog_admin
